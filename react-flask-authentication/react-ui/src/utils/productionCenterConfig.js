...
export const CUTTING_ROOMS = {
  ZALLI: 'ZALLI',
  VERONA: 'VERONA',
  TEXTILE_CONSTRUCTION: 'TEXTILE CONSTRUCTION',
  VEGATEX: 'VEGATEX',
...
export const PRODUCTION_CENTER_CUTTING_ROOMS = {
  [PRODUCTION_CENTERS.PXE1]: [
    ...
    CUTTING_ROOMS.TEXTILE_CONSTRUCTION
  ],
...
export const CUTTING_ROOM_DESTINATIONS = {
  ...
  [CUTTING_ROOMS.TEXTILE_CONSTRUCTION]: [
    DESTINATIONS.TEXTILE_CONSTRUCTION
  ],
...
export const COMBINATION_KEYS = {
  ...
  [`${CUTTING_ROOMS.TEXTILE_CONSTRUCTION}+${DESTINATIONS.TEXTILE_CONSTRUCTION}`]: 'TT',
